...
class MainPage extends React.Component {
  render() {
    ...
    >
    <Menu.Item key="1">
          <span className="nav-text"><img src="https://www.lonelyplanet.com/news/wp-content/uploads/2017/03/16124365_1117534098374780_5466006995590971392_n-e1488475313343.jpg" width="50%"/></span>
        </Menu.Item>
        <Menu.Item key="2">
