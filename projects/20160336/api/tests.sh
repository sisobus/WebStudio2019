...
# /login api test
curl -H "Content-Type: application/json" -X POST -d '{"email": "sisobus@vuno.co", "password": "1234qwer"}' http://localhost:5000/api/auth/login
curl -H "Content-Type: application/json" -X POST -d '{"email": "sisobus3@vuno.co", "password": "1234qwer1"}' http://localhost:5000/api/auth/login
curl -H "Content-Type: application/json" -X POST -d '{"email": "sisobus3@vuno.co", "password": "1234qwer"}' http://localhost:5000/api/auth/login
